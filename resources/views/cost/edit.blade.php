<x-app-layout>
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100 dark:bg-gray-900">
        ...
        <div class="w-full sm:max-w-xl mt-6 px-6 py-4 bg-white dark:bg-gray-800 shadow-md overflow-hidden sm:rounded-lg">
            ...
            <form method="POST" enctype="multipart/form-data" action={{ route('receiptMAList.update', $receiptMA_id) }}>
                @csrf
                @method('patch')
                ...
                <div class="grid grid-rows-1 grid-flow-col gap-2">
                    ...
                    <div class="mt-4">
                        <x-text-input id="repairCost" class="block mt-1 w-full" type="text"
                            name="rowID_{{ $cost_repair->id }}" value="{{ $cost_repair->cost }}" />
                ...
                <div class="grid grid-rows-1 grid-flow-col gap-2">
                    ...
                    <div class="mt-4">
                        <x-text-input id="elementCost" class="block mt-1 w-full" type="text"
                            name="rowID_{{ $cost_element->id }}" value="{{ $cost_element->cost }}" />
                ...
                <div class="grid grid-rows-1 grid-flow-col gap-2">
                    ...
                    <div class="mt-4">
                        <x-text-input id="travelCost" class="block mt-1 w-full" type="text"
                            name="rowID_{{ $cost_travel->id }}" value="{{ $cost_travel->cost }}" />
                ...
                <div class="grid grid-rows-1 grid-flow-col gap-2">
                    ...
                    <div class="mt-4">
                        <x-text-input id="deviceCost" class="block mt-1 w-full" type="text"
                            name="rowID_{{ $cost_device->id }}" value="{{ $cost_device->cost }}" />
